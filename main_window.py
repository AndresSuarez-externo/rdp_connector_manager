...
class MainWindow:
    ...
    def __init__(self, master,password, config):
        master.title("rdp_connector_manager by BBVA")
    ...
    def delete_client(self):
        ...
        if messagebox.askyesno(title="Definitivamente?", message=f"¿Quiere eliminar siguiente usuario difinitivamente {to_be_deleted}?"):
