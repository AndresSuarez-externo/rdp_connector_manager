...
class PassCheck:
    ...
    def create_widgets(self):
        ...
        self.filemenu.add_command(label="Configuracion", command= self.open_config_window)
        self.filemenu.add_command(label="Salida", command=self.master.quit)
        self.menubar.add_cascade(label="Opción", menu=self.filemenu)
